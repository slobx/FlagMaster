...
public class NorthAmericaCustomList extends ArrayAdapter<String> {

    private final Activity context;
    private final ArrayList<String> web;
    private final ArrayList<Integer> flagImageId;

    public NorthAmericaCustomList(Activity context,
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (prefs.getBoolean("NORTHAMERICABOOLEAN" + position, true)){
        ...
        rowView.setBackgroundResource(R.drawable.northamericabackground);
