...
public class OthersCustomList extends ArrayAdapter<String> {

    private final Activity context;
    private final ArrayList<String> web;
    private final ArrayList<Integer> flagImageId;

    public OthersCustomList(Activity context,
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (prefs.getBoolean("OTHERSBOOLEAN" + position, true)){
        ...
        rowView.setBackgroundResource(R.drawable.othersbackground);
