...
public class AfricaCustomList extends ArrayAdapter<String> {

    private final Activity context;
    private final ArrayList<String> web;
    private final ArrayList<Integer> flagImageId;

    public AfricaCustomList(Activity context,
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (prefs.getBoolean("AFRICABOOLEAN" + position, true)){
        ...
        rowView.setBackgroundResource(R.drawable.africabackground);
