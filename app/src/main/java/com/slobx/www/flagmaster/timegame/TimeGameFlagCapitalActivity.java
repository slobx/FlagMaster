...
public class TimeGameFlagCapitalActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_time_game_flag_capital);
    ...
    public void setDialog() {
        ...
        final Dialog dialog = new Dialog(TimeGameFlagCapitalActivity.this);
...
//        imageViewDialog.setImageResource(R.drawable.greencorrect);
        ...
        playAgainButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), TimeGameFlagCapitalActivity.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    public void onBackPressed() {
        ...
        final Dialog dialog = new Dialog(TimeGameFlagCapitalActivity.this, R.style.Theme_Dialog);
    ...
    public class CounterClass extends CountDownTimer {
        ...
        public void amateurAchievement(){
            if (numberOfGames == 1 && amateurBoolean){
                ...
                Toast toast = Toast.makeText(TimeGameFlagCapitalActivity.this, "Congratulations! You unlocked AMATEUR achievement. 50 stars are added to your account. " +
        ...
        public void beginnerAchievementOne(){
            if (numberOfGames == 10 && beginnerOneBoolean){
                ...
                Toast toast = Toast.makeText(TimeGameFlagCapitalActivity.this, "Congratulations! You unlocked BEGINNER I achievement. 50 stars are added to your account", Toast.LENGTH_LONG);
                toast.show();
        ...
        public void beginnerAchievementTwo(){
            if (numberOfGames == 25 && beginnerTwoBoolean){
                ...
                Toast toast = Toast.makeText(TimeGameFlagCapitalActivity.this, "Congratulations! You unlocked BEGINNER II achievement. 150 stars are added to your account", Toast.LENGTH_LONG);
                toast.show();
        ...
        public void beginnerAchievementThree(){
            if (numberOfGames == 50 && beginnerThreeBoolean){
                ...
                Toast toast = Toast.makeText(TimeGameFlagCapitalActivity.this, "Congratulations! You unlocked BEGINNER III achievement. 400 stars are added to your account", Toast.LENGTH_LONG);
                toast.show();
        ...
        public void beginnerAchievementFour(){
            if (numberOfGames == 100 && beginnerFourBoolean){
                ...
                Toast toast = Toast.makeText(TimeGameFlagCapitalActivity.this, "Congratulations! You unlocked BEGINNER IV achievement. 1000 stars are added to your account", Toast.LENGTH_LONG);
                toast.show();
        ...
        public void ultimateAchievementOne(){
            ...
            if (numberOfUltimateGames == 10 && ultimateOneBoolean){
                ...
                Toast toast = Toast.makeText(TimeGameFlagCapitalActivity.this, "Congratulations! You unlocked ULTIMATE I achievement. 150 stars are added to your account", Toast.LENGTH_LONG);
                toast.show();
        ...
        public void ultimateAchievementTwo(){
            ...
            if (numberOfUltimateGames == 25 && ultimateTwoBoolean){
                ...
                Toast toast = Toast.makeText(TimeGameFlagCapitalActivity.this, "Congratulations! You unlocked ULTIMATE II achievement. 400 stars are added to your account", Toast.LENGTH_LONG);
                toast.show();
        ...
        public void ultimateAchievementThree(){
            ...
            if (numberOfUltimateGames == 50 && ultimateThreeBoolean){
                ...
                Toast toast = Toast.makeText(TimeGameFlagCapitalActivity.this, "Congratulations! You unlocked ULTIMATE III achievement. 1000 stars are added to your account", Toast.LENGTH_LONG);
                toast.show();
        ...
        public void ultimateAchievementFour(){
            ...
            if (numberOfUltimateGames == 100 && ultimateFourBoolean){
                ...
                Toast toast = Toast.makeText(TimeGameFlagCapitalActivity.this, "Congratulations! You unlocked ULTIMATE IV achievement. 2500 stars are added to your account", Toast.LENGTH_LONG);
                toast.show();
    ...
    public void europeanAchievementOne(){
        ...
        if (europeanInt == 100 && europeanOneBoolean){
            ...
            Toast toast = Toast.makeText(TimeGameFlagCapitalActivity.this, "Congratulations! You unlocked EUROPE I achievement. 200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void europeanAchievementTwo(){
        ...
        if (europeanInt == 500 && europeanTwoBoolean){
            ...
            Toast toast = Toast.makeText(TimeGameFlagCapitalActivity.this, "Congratulations! You unlocked EUROPE II achievement. 1200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void europeanAchievementThree(){
        ...
        if (europeanInt == 1000 && europeanThreeBoolean){
            ...
            Toast toast = Toast.makeText(TimeGameFlagCapitalActivity.this, "Congratulations! You unlocked EUROPE III achievement. 2500 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void asianAchievementOne(){
        ...
        if (asianInt == 100 && asianOneBoolean){
            ...
            Toast toast = Toast.makeText(TimeGameFlagCapitalActivity.this, "Congratulations! You unlocked ASIA I achievement. 200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void asianAchievementTwo(){
        ...
        if (asianInt == 500 && asianTwoBoolean){
            ...
            Toast toast = Toast.makeText(TimeGameFlagCapitalActivity.this, "Congratulations! You unlocked ASIA II achievement. 1200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void asianAchievementThree(){
        ...
        if (asianInt == 1000 && asianThreeBoolean){
            ...
            Toast toast = Toast.makeText(TimeGameFlagCapitalActivity.this, "Congratulations! You unlocked ASIA III achievement. 2500 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void africanAchievementOne(){
        ...
        if (africanInt == 100 && africanOneBoolean){
            ...
            Toast toast = Toast.makeText(TimeGameFlagCapitalActivity.this, "Congratulations! You unlocked AFRICA I achievement. 200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void africanAchievementTwo(){
        ...
        if (africanInt == 500 && africanTwoBoolean){
            ...
            Toast toast = Toast.makeText(TimeGameFlagCapitalActivity.this, "Congratulations! You unlocked AFRICA II achievement. 1200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void africanAchievementThree(){
        ...
        if (africanInt == 1000 && africanThreeBoolean){
            ...
            Toast toast = Toast.makeText(TimeGameFlagCapitalActivity.this, "Congratulations! You unlocked AFRICA III achievement. 2500 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void northAmericanAchievementOne(){
        ...
        if (northAmericanInt == 100 && northAmericanOneBoolean){
            ...
            Toast toast = Toast.makeText(TimeGameFlagCapitalActivity.this, "Congratulations! You unlocked NORTH AMERICA I achievement. 200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void northAmericanAchievementTwo(){
        ...
        if (northAmericanInt == 500 && northAmericanTwoBoolean){
            ...
            Toast toast = Toast.makeText(TimeGameFlagCapitalActivity.this, "Congratulations! You unlocked NORTH AMERICA II achievement. 1200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void northAmericanAchievementThree(){
        ...
        if (northAmericanInt == 1000 && northAmericanThreeBoolean){
            ...
            Toast toast = Toast.makeText(TimeGameFlagCapitalActivity.this, "Congratulations! You unlocked NORTH AMERICA III achievement. 2500 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void southAmericanAchievementOne(){
        ...
        if (southAmericanInt == 100 && southAmericanOneBoolean){
            ...
            Toast toast = Toast.makeText(TimeGameFlagCapitalActivity.this, "Congratulations! You unlocked SOUTH AMERICA I achievement. 200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void southAmericanAchievementTwo(){
        ...
        if (southAmericanInt == 500 && southAmericanTwoBoolean){
            ...
            Toast toast = Toast.makeText(TimeGameFlagCapitalActivity.this, "Congratulations! You unlocked SOUTH AMERICA II achievement. 1200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void southAmericanAchievementThree(){
        ...
        if (southAmericanInt == 1000 && southAmericanThreeBoolean){
            ...
            Toast toast = Toast.makeText(TimeGameFlagCapitalActivity.this, "Congratulations! You unlocked SOUTH AMERICA III achievement. 2500 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void oceaniaAchievementOne(){
        ...
        if (oceaniaInt == 100 && oceaniaOneBoolean){
            ...
            Toast toast = Toast.makeText(TimeGameFlagCapitalActivity.this, "Congratulations! You unlocked OCEANIA I achievement. 200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void oceaniaAchievementTwo(){
        ...
        if (oceaniaInt == 500 && oceaniaTwoBoolean){
            ...
            Toast toast = Toast.makeText(TimeGameFlagCapitalActivity.this, "Congratulations! You unlocked OCEANIA II achievement. 1200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void oceaniaAchievementThree(){
        ...
        if (oceaniaInt == 1000 && oceaniaThreeBoolean){
            ...
            Toast toast = Toast.makeText(TimeGameFlagCapitalActivity.this, "Congratulations! You unlocked OCEANIA III achievement. 2500 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
