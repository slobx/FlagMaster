...
public class NormalGameFlagCapitalActivity extends Activity {

    public Button buttonFlag1;
    public Button buttonFlag2;
    public Button buttonFlag3;
    public Button buttonFlag4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_normal_game_flag_name);
        ...
        buttonFlag1 = (Button) findViewById(R.id.buttonFlagName1);
        buttonFlag2 = (Button) findViewById(R.id.buttonFlagName2);
        buttonFlag3 = (Button) findViewById(R.id.buttonFlagName3);
        buttonFlag4 = (Button) findViewById(R.id.buttonFlagName4);
        ...
        questionImageView = (ImageView) findViewById(R.id.countryFlagImageView);
        leftTextView = (TextView) findViewById(R.id.leftTextView);
        scoreTextView = (TextView) findViewById(R.id.scoreTextViev);

        left = 1;
        leftTextView.setText(left + "/20");
    ...
    public int setFlags() {
        ...
        buttonFlag1.setBackgroundResource(R.drawable.countrybuttonbackground);
        buttonFlag2.setBackgroundResource(R.drawable.countrybuttonbackground);
        buttonFlag3.setBackgroundResource(R.drawable.countrybuttonbackground);
        buttonFlag4.setBackgroundResource(R.drawable.countrybuttonbackground);
        ...
        int firstFlagID = rand.nextInt(countriesNameListInMethod.size());
        buttonFlag1.setText(countriesNameListInMethod.get(firstFlagID));
        buttonFlag1.setTag(countriesNameListInMethod.get(firstFlagID));
        ...
        int secondFlagID = rand.nextInt(countriesNameListInMethod.size());
        buttonFlag2.setText(countriesNameListInMethod.get(secondFlagID));
        buttonFlag2.setTag(countriesNameListInMethod.get(secondFlagID));
        ...
        int thirdFlagID = rand.nextInt(countriesNameListInMethod.size());
        buttonFlag3.setText(countriesNameListInMethod.get(thirdFlagID));
        buttonFlag3.setTag(countriesNameListInMethod.get(thirdFlagID));
        ...
        int fourthFlagID = rand.nextInt(countriesNameListInMethod.size());
        buttonFlag4.setText(countriesNameListInMethod.get(fourthFlagID));
        buttonFlag4.setTag(countriesNameListInMethod.get(fourthFlagID));
        ...
        int randID = rand.nextInt(countriesNameListCopy.size());
        String answer = countriesNameListCopy.get(randID);
        questionImageView.setImageResource(flagListCopy.get(randID));
    ...
    public void buttonOnClickArcadeGame(View v) {
        switch (v.getId()) {
            case R.id.buttonFlagName1:
                ...
                if (returningID == countriesNameList.indexOf((String)buttonFlag1.getTag())){
                    buttonFlag1.setBackgroundResource(R.drawable.countrybuttoncorrect_anim);
                    AnimationDrawable anim = (AnimationDrawable) buttonFlag1.getBackground();
                    anim.start();
                    ...
                    buttonFlag1.setClickable(false);
                    buttonFlag1.setBackgroundResource(R.drawable.countrybuttonfalse_anim);
                    AnimationDrawable anim = (AnimationDrawable) buttonFlag1.getBackground();
                    anim.start();
                    if (vibrationOnOff)
                        vibe.vibrate(100);
            ...
            case R.id.buttonFlagName2:
                ...
                if (returningID == countriesNameList.indexOf((String)buttonFlag2.getTag())){
                    buttonFlag2.setBackgroundResource(R.drawable.countrybuttoncorrect_anim);
                    AnimationDrawable anim = (AnimationDrawable) buttonFlag2.getBackground();
                    anim.start();
                    if (vibrationOnOff)
                        vibe.vibrate(vibratePattern, -1);
                    if (soundOnOff) {
                    ...
                    buttonFlag2.setClickable(false);
                    buttonFlag2.setBackgroundResource(R.drawable.countrybuttonfalse_anim);
                    AnimationDrawable anim = (AnimationDrawable) buttonFlag2.getBackground();
                    anim.start();
                    if (vibrationOnOff)
                        vibe.vibrate(100);
            ...
            case R.id.buttonFlagName3:
                ...
                if (returningID == countriesNameList.indexOf((String)buttonFlag3.getTag())){
                    buttonFlag3.setBackgroundResource(R.drawable.countrybuttoncorrect_anim);
                    AnimationDrawable anim = (AnimationDrawable) buttonFlag3.getBackground();
                    anim.start();
                    if (vibrationOnOff)
                        vibe.vibrate(vibratePattern, -1);
                    if (soundOnOff) {
                    ...
                    buttonFlag3.setClickable(false);
                    buttonFlag3.setBackgroundResource(R.drawable.countrybuttonfalse_anim);
                    AnimationDrawable anim = (AnimationDrawable) buttonFlag3.getBackground();
                    anim.start();
                    if (vibrationOnOff)
                        vibe.vibrate(100);
            ...
            case R.id.buttonFlagName4:
                ...
                if (returningID == countriesNameList.indexOf((String)buttonFlag4.getTag())){
                    buttonFlag4.setBackgroundResource(R.drawable.countrybuttoncorrect_anim);
                    AnimationDrawable anim = (AnimationDrawable) buttonFlag4.getBackground();
                    anim.start();
                    if (vibrationOnOff)
                        vibe.vibrate(vibratePattern, -1);
                    if (soundOnOff) {
                    ...
                    buttonFlag4.setClickable(false);
                    buttonFlag4.setBackgroundResource(R.drawable.countrybuttonfalse_anim);
                    AnimationDrawable anim = (AnimationDrawable) buttonFlag4.getBackground();
                    anim.start();
                    if (vibrationOnOff)
                        vibe.vibrate(100);
    ...
    public void setDialog() {
        ...
        final Dialog dialog = new Dialog(NormalGameFlagCapitalActivity.this);
...
//        imageViewDialog.setImageResource(R.drawable.greencorrect);
        ...
        playAgainButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), NormalGameFlagCapitalActivity.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    public void onBackPressed() {
        final Dialog dialog = new Dialog(NormalGameFlagCapitalActivity.this, R.style.Theme_Dialog);
    ...
    public void toastForUnlockAchievement10(){
        ...
        Toast toast = Toast.makeText(NormalGameFlagCapitalActivity.this, "Congratulations! You unlocked MASTER I achievement. 100 stars are added to your account", Toast.LENGTH_LONG);
        toast.show();
    ...
    public void toastForUnlockAchievement25(){
        ...
        Toast toast = Toast.makeText(NormalGameFlagCapitalActivity.this, "Congratulations! You unlocked MASTER II achievement. 300 stars are added to your account", Toast.LENGTH_LONG);
        toast.show();
    ...
    public void toastForUnlockAchievement50(){
        ...
        Toast toast = Toast.makeText(NormalGameFlagCapitalActivity.this, "Congratulations! You unlocked MASTER III achievement. 700 stars are added to your account", Toast.LENGTH_LONG);
        toast.show();
    ...
    public void toastForUnlockAchievement100(){
        ...
        Toast toast = Toast.makeText(NormalGameFlagCapitalActivity.this, "Congratulations! You unlocked MASTER IV achievement. 1500 stars are added to your account", Toast.LENGTH_LONG);
        toast.show();
    ...
    public void amateurAchievement(){
        if (numberOfGames == 1 && amateurBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameFlagCapitalActivity.this, "Congratulations! You unlocked AMATEUR achievement. 50 stars are added to your account. " +
    ...
    public void beginnerAchievementOne(){
        if (numberOfGames == 10 && beginnerOneBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameFlagCapitalActivity.this, "Congratulations! You unlocked BEGINNER I achievement. 50 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void beginnerAchievementTwo(){
        if (numberOfGames == 25 && beginnerTwoBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameFlagCapitalActivity.this, "Congratulations! You unlocked BEGINNER II achievement. 150 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void beginnerAchievementThree(){
        if (numberOfGames == 50 && beginnerThreeBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameFlagCapitalActivity.this, "Congratulations! You unlocked BEGINNER III achievement. 400 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void beginnerAchievementFour(){
        if (numberOfGames == 100 && beginnerFourBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameFlagCapitalActivity.this, "Congratulations! You unlocked BEGINNER IV achievement. 1000 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void europeanAchievementOne(){
        ...
        if (europeanInt == 100 && europeanOneBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameFlagCapitalActivity.this, "Congratulations! You unlocked EUROPE I achievement. 200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void europeanAchievementTwo(){
        ...
        if (europeanInt == 500 && europeanTwoBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameFlagCapitalActivity.this, "Congratulations! You unlocked EUROPE II achievement. 1200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void europeanAchievementThree(){
        ...
        if (europeanInt == 1000 && europeanThreeBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameFlagCapitalActivity.this, "Congratulations! You unlocked EUROPE III achievement. 2500 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void asianAchievementOne(){
        ...
        if (asianInt == 100 && asianOneBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameFlagCapitalActivity.this, "Congratulations! You unlocked ASIA I achievement. 200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void asianAchievementTwo(){
        ...
        if (asianInt == 500 && asianTwoBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameFlagCapitalActivity.this, "Congratulations! You unlocked ASIA II achievement. 1200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void asianAchievementThree(){
        ...
        if (asianInt == 1000 && asianThreeBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameFlagCapitalActivity.this, "Congratulations! You unlocked ASIA III achievement. 2500 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void africanAchievementOne(){
        ...
        if (africanInt == 100 && africanOneBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameFlagCapitalActivity.this, "Congratulations! You unlocked AFRICA I achievement. 200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void africanAchievementTwo(){
        ...
        if (africanInt == 500 && africanTwoBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameFlagCapitalActivity.this, "Congratulations! You unlocked AFRICA II achievement. 1200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void africanAchievementThree(){
        ...
        if (africanInt == 1000 && africanThreeBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameFlagCapitalActivity.this, "Congratulations! You unlocked AFRICA III achievement. 2500 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void northAmericanAchievementOne(){
        ...
        if (northAmericanInt == 100 && northAmericanOneBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameFlagCapitalActivity.this, "Congratulations! You unlocked NORTH AMERICA I achievement. 200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void northAmericanAchievementTwo(){
        ...
        if (northAmericanInt == 500 && northAmericanTwoBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameFlagCapitalActivity.this, "Congratulations! You unlocked NORTH AMERICA II achievement. 1200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void northAmericanAchievementThree(){
        ...
        if (northAmericanInt == 1000 && northAmericanThreeBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameFlagCapitalActivity.this, "Congratulations! You unlocked NORTH AMERICA III achievement. 2500 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void southAmericanAchievementOne(){
        ...
        if (southAmericanInt == 100 && southAmericanOneBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameFlagCapitalActivity.this, "Congratulations! You unlocked SOUTH AMERICA I achievement. 200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void southAmericanAchievementTwo(){
        ...
        if (southAmericanInt == 500 && southAmericanTwoBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameFlagCapitalActivity.this, "Congratulations! You unlocked SOUTH AMERICA II achievement. 1200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void southAmericanAchievementThree(){
        ...
        if (southAmericanInt == 1000 && southAmericanThreeBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameFlagCapitalActivity.this, "Congratulations! You unlocked SOUTH AMERICA III achievement. 2500 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void oceaniaAchievementOne(){
        ...
        if (oceaniaInt == 100 && oceaniaOneBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameFlagCapitalActivity.this, "Congratulations! You unlocked OCEANIA I achievement. 200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void oceaniaAchievementTwo(){
        ...
        if (oceaniaInt == 500 && oceaniaTwoBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameFlagCapitalActivity.this, "Congratulations! You unlocked OCEANIA II achievement. 1200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void oceaniaAchievementThree(){
        ...
        if (oceaniaInt == 1000 && oceaniaThreeBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameFlagCapitalActivity.this, "Congratulations! You unlocked OCEANIA III achievement. 2500 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
