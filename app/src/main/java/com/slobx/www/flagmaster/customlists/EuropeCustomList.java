...
public class EuropeCustomList extends ArrayAdapter<String> {

    private final Activity context;
    private final ArrayList<String> web;
    private final ArrayList<Integer> flagImageId;

    public EuropeCustomList(Activity context,
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (prefs.getBoolean("EUROPEBOOLEAN" + position, true)) {
        ...
        rowView.setBackgroundResource(R.drawable.europebackground);
