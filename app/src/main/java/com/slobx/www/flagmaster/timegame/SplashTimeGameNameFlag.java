...
public class SplashTimeGameNameFlag extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myHandler.postDelayed(runnable3sec, 1600);


    }

    public void nextActivity() {
        Intent intent = new Intent(this, TimeGameNameFlagActivity.class);
