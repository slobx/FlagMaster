...
public class NormalGameCapitalFlagActivity extends Activity {
    ...
    private final String[] europeArray = {"Moscow", "Paris", "Madrid", "Stockholm", "Oslo",
    ...
    private final String[] asiaArray = {"Kabul", "Beijing","New Delhi","Jakarta","Tehran","Baghdad","Jerusalem","Tokyo","Kuala Lumpur","Pyongyang",
    ...
    private final String[] africaArray = {"Algiers","Luanda","Yaounde","Brazzaville","Yamoussoukro","Cairo","Accra","Nairobi","Port Louis","Rabat","Abuja","Dakar","Tunis",
    ...
    private final String[] northAmericaArray = {"Washington","Nassau","Mexico City","San Jose","Havana","Kingston","Bridgetown","Port of Spain",
    ...
    private final String[] southAmericaArray = {"Buenos Aires","Brasilia","Bogota","La Paz", "Santiago","Quito","Georgetown","Asuncion","Lima","Montevideo","Caracas"};

    private final String[] oceaniaArray = {"Canberra","Port Moresby","Wellington","Suva","Honiara","Port Vila","Apia","South Tarawa","Nukuʻalofa","Majuro","Ngerulmud", "Yaren"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_normal_game_capital_flag);
    ...
    public int setFlags() {
        ...
        //setting array list for loading different flags in one game
        ...
        //setting the flags and removing guessed flag from array
        //it helps that we always have different flags as answer in one game
        ...
        questionTextView.setText(countriesNameListCopy.get(randID));
        ...
        //we are returning this info as ID from correct answer to compare it with clicked flag
        return returningID;
    ...
    public void buttonOnClickArcadeGame(View v) {
        switch (v.getId()) {
            case R.id.buttonImageView:
                ...
                //comparing right answer with clicked flag and setting sound,animation if its correct or false
                //also if answer is correct we update all achievements
                if (returningID == flagsList.indexOf((Integer)buttonFlag1.getTag())){
                    ...
                    //making pause between right answer and loading next question to see animation
                    ...
                    //answer is wrong, setting button unclickable, setting animation on button
                    buttonFlag1.setClickable(false);
                    buttonFlagRedX1.setVisibility(View.VISIBLE);
    ...
    public void setDialog() {
        ...
        //setting dialog after game is finished

        int numberOfStars = totalNumberOfStars;
        int summaryStars;

        //for design purpose setting all buttons and scores in corners invisible
        ...
        final Dialog dialog = new Dialog(NormalGameCapitalFlagActivity.this);
...
//        imageViewDialog.setImageResource(R.drawable.greencorrect);
        ...
        playAgainButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), NormalGameCapitalFlagActivity.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    public void onBackPressed() {
        final Dialog dialog = new Dialog(NormalGameCapitalFlagActivity.this, R.style.Theme_Dialog);
    ...
    public void toastForUnlockAchievement10(){
        ...
        Toast toast = Toast.makeText(NormalGameCapitalFlagActivity.this, "Congratulations! You unlocked MASTER I achievement. 100 stars are added to your account", Toast.LENGTH_LONG);
        toast.show();
    ...
    public void toastForUnlockAchievement25(){
        ...
        Toast toast = Toast.makeText(NormalGameCapitalFlagActivity.this, "Congratulations! You unlocked MASTER II achievement. 300 stars are added to your account", Toast.LENGTH_LONG);
        toast.show();
    ...
    public void toastForUnlockAchievement50(){
        ...
        Toast toast = Toast.makeText(NormalGameCapitalFlagActivity.this, "Congratulations! You unlocked MASTER III achievement. 700 stars are added to your account", Toast.LENGTH_LONG);
        toast.show();
    ...
    public void toastForUnlockAchievement100(){
        ...
        Toast toast = Toast.makeText(NormalGameCapitalFlagActivity.this, "Congratulations! You unlocked MASTER IV achievement. 1500 stars are added to your account", Toast.LENGTH_LONG);
        toast.show();
    ...
    public void amateurAchievement(){
        if (numberOfGames == 1 && amateurBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameCapitalFlagActivity.this, "Congratulations! You unlocked AMATEUR achievement. 50 stars are added to your account. " +
    ...
    public void beginnerAchievementOne(){
        if (numberOfGames == 10 && beginnerOneBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameCapitalFlagActivity.this, "Congratulations! You unlocked BEGINNER I achievement. 50 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void beginnerAchievementTwo(){
        if (numberOfGames == 25 && beginnerTwoBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameCapitalFlagActivity.this, "Congratulations! You unlocked BEGINNER II achievement. 150 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void beginnerAchievementThree(){
        if (numberOfGames == 50 && beginnerThreeBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameCapitalFlagActivity.this, "Congratulations! You unlocked BEGINNER III achievement. 400 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void beginnerAchievementFour(){
        if (numberOfGames == 100 && beginnerFourBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameCapitalFlagActivity.this, "Congratulations! You unlocked BEGINNER IV achievement. 1000 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void europeanAchievementOne(){
        ...
        if (europeanInt == 100 && europeanOneBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameCapitalFlagActivity.this, "Congratulations! You unlocked EUROPE I achievement. 200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void europeanAchievementTwo(){
        ...
        if (europeanInt == 500 && europeanTwoBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameCapitalFlagActivity.this, "Congratulations! You unlocked EUROPE II achievement. 1200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void europeanAchievementThree(){
        ...
        if (europeanInt == 1000 && europeanThreeBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameCapitalFlagActivity.this, "Congratulations! You unlocked EUROPE III achievement. 2500 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void asianAchievementOne(){
        ...
        if (asianInt == 100 && asianOneBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameCapitalFlagActivity.this, "Congratulations! You unlocked ASIA I achievement. 200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void asianAchievementTwo(){
        ...
        if (asianInt == 500 && asianTwoBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameCapitalFlagActivity.this, "Congratulations! You unlocked ASIA II achievement. 1200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void asianAchievementThree(){
        ...
        if (asianInt == 1000 && asianThreeBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameCapitalFlagActivity.this, "Congratulations! You unlocked ASIA III achievement. 2500 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void africanAchievementOne(){
        ...
        if (africanInt == 100 && africanOneBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameCapitalFlagActivity.this, "Congratulations! You unlocked AFRICA I achievement. 200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void africanAchievementTwo(){
        ...
        if (africanInt == 500 && africanTwoBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameCapitalFlagActivity.this, "Congratulations! You unlocked AFRICA II achievement. 1200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void africanAchievementThree(){
        ...
        if (africanInt == 1000 && africanThreeBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameCapitalFlagActivity.this, "Congratulations! You unlocked AFRICA III achievement. 2500 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void northAmericanAchievementOne(){
        ...
        if (northAmericanInt == 100 && northAmericanOneBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameCapitalFlagActivity.this, "Congratulations! You unlocked NORTH AMERICA I achievement. 200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void northAmericanAchievementTwo(){
        ...
        if (northAmericanInt == 500 && northAmericanTwoBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameCapitalFlagActivity.this, "Congratulations! You unlocked NORTH AMERICA II achievement. 1200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void northAmericanAchievementThree(){
        ...
        if (northAmericanInt == 1000 && northAmericanThreeBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameCapitalFlagActivity.this, "Congratulations! You unlocked NORTH AMERICA III achievement. 2500 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void southAmericanAchievementOne(){
        ...
        if (southAmericanInt == 100 && southAmericanOneBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameCapitalFlagActivity.this, "Congratulations! You unlocked SOUTH AMERICA I achievement. 200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void southAmericanAchievementTwo(){
        ...
        if (southAmericanInt == 500 && southAmericanTwoBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameCapitalFlagActivity.this, "Congratulations! You unlocked SOUTH AMERICA II achievement. 1200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void southAmericanAchievementThree(){
        ...
        if (southAmericanInt == 1000 && southAmericanThreeBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameCapitalFlagActivity.this, "Congratulations! You unlocked SOUTH AMERICA III achievement. 2500 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void oceaniaAchievementOne(){
        ...
        if (oceaniaInt == 100 && oceaniaOneBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameCapitalFlagActivity.this, "Congratulations! You unlocked OCEANIA I achievement. 200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void oceaniaAchievementTwo(){
        ...
        if (oceaniaInt == 500 && oceaniaTwoBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameCapitalFlagActivity.this, "Congratulations! You unlocked OCEANIA II achievement. 1200 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void oceaniaAchievementThree(){
        ...
        if (oceaniaInt == 1000 && oceaniaThreeBoolean){
            ...
            Toast toast = Toast.makeText(NormalGameCapitalFlagActivity.this, "Congratulations! You unlocked OCEANIA III achievement. 2500 stars are added to your account", Toast.LENGTH_LONG);
            toast.show();
