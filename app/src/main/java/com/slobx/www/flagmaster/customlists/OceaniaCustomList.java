...
public class OceaniaCustomList extends ArrayAdapter<String> {

    private final Activity context;
    private final ArrayList<String> web;
    private final ArrayList<Integer> flagImageId;

    public OceaniaCustomList(Activity context,
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (prefs.getBoolean("OCEANIABOOLEAN" + position, true)){
        ...
        rowView.setBackgroundResource(R.drawable.oceaniabackground);
