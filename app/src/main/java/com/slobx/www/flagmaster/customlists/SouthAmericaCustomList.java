...
public class SouthAmericaCustomList extends ArrayAdapter<String> {

    private final Activity context;
    private final ArrayList<String> web;
    private final ArrayList<Integer> flagImageId;

    public SouthAmericaCustomList(Activity context,
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (prefs.getBoolean("SOUTHAMERICABOOLEAN" + position, true)){
        ...
        rowView.setBackgroundResource(R.drawable.southamericabackground);
